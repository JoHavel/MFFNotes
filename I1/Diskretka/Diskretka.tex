...
\section{Úvod}
    ...
    \begin{definice}[Násobení mnoha čísel]
    ...
    \begin{definice}[Délka nejdelšího řetězce a velikost největšího antiřetězce]
...
% 23. 11. 2020
    ...
    \subsection{Stromy}
        ...
        \begin{lemma}[Vandalské (trháme listy) a pěstovatelské (necháme je vyrůst)]
...
% 7. 12. 2020
    ...
    \subsection{Barvení grafů}
        \begin{definice}[Obarvení a barevnost]
        ...
        \begin{poznamka}[Barevnost rovinných grafů]
            Už víme: $\chi ≤ 6$.
        ...
        \begin{veta}[O 5 barvách]
            ...
            \begin{dukazin}[Tzv. Kempeho řetězce]
            ...
            \begin{dukazin}[Písní (Kempeho řetězce)]
...
\section{Teorie pravděpodobnosti}
    ...
    \begin{definice}[Diskrétní pravděpodobnostní prostor]
...
% 21. 12. 2020
    ...
    \begin{priklad}[Bertrandův paradox]
    ...
    \begin{definice}[Součin diskrétních pravděpodobnostních prostorů]
    ...
    \begin{definice}[Střední hodnota]
        ...
        \vskip -2em (V nekonečných pravděpodobnostních prostorech nemusí existovat.)
    \end{definice}

    \begin{veta}[O linearitě střední hodnoty]
