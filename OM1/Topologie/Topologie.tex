...
\section{Úplnost}
    ...
    \begin{veta}[Alexandrov]
        ...
        \begin{dukazin}
            ...
            $$ \n \in ®N: \lim_{i, j \rightarrow ∞}\left| \frac{1}{\rho(y_i, F_n)} - \frac{1}{\rho(y_j, F_n)} \right| = 0 (\text{protože $(y_i)$ je $\rho'$ cauchyovská.}) $$ 
    ...
    \begin{lemma}[O přírůstku kompaktifikací]
        ...
        \begin{dukazin}
            ...
            Obrácená inkluze sporem: $\exists y \in ®Y \setminus ®X: f(y) = x \in ®X$. Existuje otevřené okolí $U$ bodu $x$, že $y \notin \overline{U}$ $(y ≠ x)$. Ze spojitosti $f: \overline{®X \setminus U} = \overline{f^{-1}(®X \seminus U)} = f^{-1}(\overline{®X \setminus U})$
        \end{dukazin}
    \end{lemma}
