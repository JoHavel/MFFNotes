...
\section{Základní pojmy}
    ...
    \subsection{Spojitá zobrazení}
        ...
        \begin{tvrzeni}[Charakterizace spojitých zobrazení]
            ...
            6) $\forall ®A \subseteq ®X: f(\overline{®A}) \subseteq f(®A)$\\
            ...
            \begin{dukazin}
                ...
                6->7 Ať $®B \subseteq Y$, $A := f^{-1}(®B)$. Dle 6 $f(\overline{f^{-1}(®B)}) \subseteq \overline{f(f^{-1}(®B))}\subseteq \overline{®B}$. $f^{-1}(®B) \subseteq f^{-1}(\overline{®B})$ (aplikováním vzoru? na předchozí).
