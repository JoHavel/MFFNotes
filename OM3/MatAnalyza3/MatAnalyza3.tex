...
% 15. 12. 2021
		...
		\begin{dukazin}
			...
			$Q(x) \in M^\perp$: Neboli $\forall y \in M$: $\<y, Q(x)\> = 0$. BÚNO $y \in M$ a $||y|| = 1$. $Q(x)$ je nejbližší v $x + M$
			$$ \implies ||Q(x)||^2 ≤ ||Q(x) - \alpha y||^2 = \<Q(x) - \alpha y, Q(x) - \alpha y\> = ||Q(x)||^2 - 2\alpha\<Q(x), y\> + \alpha^2\<y, y\> \implies $$
...
% 16. 12. 2021
	...
	\begin{veta}[Piezz-Fischerova věta]
