...
% 01. 12. 2021
		...
		\begin{veta}[Hölderova a Minkowského]
			...
			\begin{dukazin}
				...
				$$ \int_X (f + g)^p d\mu = \int_X f·(f + g)^{p-1} + g·(f + g)^{p-1} d\mu ≤ \(\int_X f^p d\mu\)^{\frac{1}{p}}\(\int_X (f = g)^{(p-1)q}\)^{\frac{1}{q}} + \(\int_X g^p d\mu\)^{\frac{1}{p}} \(\int_X (f + g)^{(p-1)q}\)^{\frac{1}{q}} ≤ $$
		...
		\begin{veta}[Trojúhelníková nerovnost v $L^p$]
			...
			\begin{dukazin}
				...
				Pro $p = ∞$: z definice $\esssup$ $\exists N_1, N_2, N_3$, $\mu(N_1) = \mu(N_2) = \mu(N_3) = 0$,
				$$ ||f||_{L^∞} = \sup_{x \in X \setminus N_1} |f(x)|, ||g||_{L^∞} = \sup_{X \setminus N_2} |g(x)|, ||f + g||_{L^∞} = \sup_{x \in X \setminus N_3} |f(x) + g(x)|, \qquad N = N_1 \cup N_2 \cup N_3. $$
