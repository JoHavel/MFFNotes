...
\begin{veta}[Vztahy mezi spektrálními rozklady $A^*A$ a $A A^*$]
...
% 25. přednáška
	...
	\begin{definice}[$k$-kroková metoda]
	...
	\begin{definice}[Konstrukce: Adam-Bashfonth]
		Explicitní.
	...
	\begin{definice}[Adams-Moulton]
		Implicitní.

		Jako výše, ale interpoluje se i v $x_{n+1}$. Řád $k+1$.
	\end{definice}

	\begin{definice}[Backward difference formulae]
	...
	\begin{definice}[Konzistentní VKM]
	...
	\begin{poznamka}[1. požadavek na stabilitu VKN]
