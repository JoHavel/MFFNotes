...
\begin{veta}
	...
	\begin{dukazin}
		...
		$$ \underline{\int_a^b f} \stackrell{n \rightarrow ∞}{\leftarrow} s(f, ©D_n) = \int_a^b s_n d\lambda^1, \overline{\int_a^b f} \stackrell{n \rightarrow ∞}{\leftarrow} S(f, ©D_n) = \int_a^b S_n d\lambda^1. $$
