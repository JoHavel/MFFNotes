...
\begin{poznamka}[Going from equations for $\bepsilon$ to equations for $\btau$]
	Using $\rot(\rot ¦v) = \nabla (\Div ¦v) - Δ ¦v$.
...
\begin{definice}[Plane strain problems]
	...
	\begin{dusledekin}[$\bepsilon_{2D}$ vs. $\btau_{2D}$]
...
\begin{poznamka}[Airy stress function]
	$$ ¦o = \Div_{2D} \btau_{2D} - \nabla_{2D} φ. $$
