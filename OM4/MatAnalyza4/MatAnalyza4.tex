...
\section{Stejnoměrná konvergence posloupností a řad funkcí}
	...
	\begin{veta}[Bolzanova-Cauchyova podmínka pro stejnoměrnou konvergenci]
...
%
	...
	\begin{veta}[Abelovo-Dirichletovo kritérium pro stejnoměrnou konvergenci]
...
\section{Absolutně spojité funkce a funkce s konečnou variací}
	...
	\begin{definice}[Horní a dolní derivace]
...
% 05. 04. 2022 Z poznámek přednášejícího

	\begin{veta}[Integrace per partes pro absolutně spojité funkce]
		Nechť $f, g \in AC([a, b])$. Potom
		$$ \int_a^b f' g = [f g]_a^b - \int_a^b f g'. $$

		\begin{dukazin} % Z poznámek spolužáků
...
\section{Fourierovy řady}
	...
	\begin{definice}[Trigonometrická řada, trigonometrický polynom]
	...
	\begin{veta}[Fourierovy vzorce]
		...
		\begin{dukazin} % Podle poznámek spolužáků
	...
	\begin{definice}[Fourierovy koeficienty, Fourierova řada, částečný součet Fourierovy řady]
	...
	\begin{dusledek}[Vět z minulého semestru]
...
% 19. 04. 2022
	...
	\begin{veta}[Jordanovo-Dirichletovo kritérium]
...
\begin{definice}[Křivková souvislost]
...
\begin{veta}[Souvislost souvislosti a křivkové souvislosti]
...
\begin{poznamka}[Souvislá křivkově nesouvislá množina]
	$\begin{cases} 0, & x ≤ 0,\\ \sin \frac{1}{x}, & x > 0.\end{cases}$
\end{poznamka}

\begin{veta}[Souvislost a otevřené množiny v $®R^n$]
