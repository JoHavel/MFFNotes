...
\begin{priklad}[$F(x)$ is connected is not enought]
...
\begin{lemma}[Lower semi-continuity and intersection]
...
\begin{dukaz}[of the previous theorem]
...
\begin{veta}[Norikov separation principle]
...
\begin{dukaz}[Norikov separation principle]
...
\begin{dusledek}[of 2. separation principle]
