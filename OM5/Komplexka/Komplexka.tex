...
\begin{tvrzeni}[Vlastnosti logaritmu]
...
% 22. 12. nebyla přednáška a minulý rok se RV probírala před OCV

\begin{veta}[Reziduová pro cykly]
...
% 22. 12. 2022 přednáška nebyla, ze zápisků z minulého roku
	...
	\begin{dukazin}
		...
		Potom a) je spojitá na $G \times G$ a b) $\forall z \in G: g(z, ·) \in ©H(G)$. Dále zvolme $\xi \in G \setminus \<\Gamma\>$ a položme $f_1(z) := (z - \xi)f(z)$, $z \in G$. Pomocí rovnosti ze začátku důkazu %a následující věty
dostáváme:
...
\begin{veta}[O derivování integrálu podle komplexního parametru]
...
\begin{definice}[Jednoduše souvislá (j. s.)]
...
\begin{definice}[Jordanova křivka]
